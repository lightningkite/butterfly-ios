...
open class ViewGenerator {
    ...
    open func generate(dependency: ActivityAccess) -> View { TODO() }
    ...
    public class Default : ViewGenerator {
        ...
        override public func generate(dependency: ActivityAccess) -> View { return newEmptyView(dependency: dependency) }
    }
}
