...
//--- ViewPager.bind(List<T>, MutableObservableProperty<Int>, (T)->UIView)
public extension UICollectionView {
    ...
    //--- ViewPager.bind(ObservableProperty<List<T>>, T, MutableObservableProperty<Int>, (ObservableProperty<T>)->UIView)
    func bind<T>(
